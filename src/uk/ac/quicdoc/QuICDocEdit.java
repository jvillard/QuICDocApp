...
class DiffArray extends JSONArray {
    ...
    /*
    private QuICDocClient mBoundService;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
		...
		mBoundService = ((QuICDocClient.LocalBinder)service).getService();

		// Tell the user about this for our demo.
		Toast.makeText(QuICDocEdit.this, R.string.quicdoc_service_connected,
			       Toast.LENGTH_SHORT).show();
	    }
		...
		// see this happen.
		mBoundService = null;
		Toast.makeText(QuICDocEdit.this, R.string.quicdoc_service_disconnected,
			       Toast.LENGTH_SHORT).show();
	    }
	};
	...
	bindService(new Intent(QuICDocEdit.this,
			       QuICDocClient.class), mConnection, Context.BIND_AUTO_CREATE);
	mIsBound = true;
    }
